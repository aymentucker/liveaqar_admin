...
@section('title', 'Dashboard | LiveAqar')
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body pb-0">
                    ...
                    <div>
                        <div id="overview"
                            data-colors='["#e6ecf9", "#e6ecf9", "#e6ecf9","#e6ecf9", "#e6ecf9", "#e6ecf9","#e6ecf9","#e6ecf9","#e6ecf9","#bf2126","#bf2126", "#bf2126"]'
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-7">
                                    <span class="badge bg-primary-subtle text-primary  font-size-10 text-uppercase ls-05">
                                        Popular Item</span>
                                    <h5 class="mt-2 font-size-16"><a href="" class="text-body">Home & Office Chair
                                            Blue</a></h5>
                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="avatar-md">
                                                <div
                                                    ...
                                                    <img src="assets/images/product/img-8.png" class="img-fluid"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="avatar-md">
                                                <div
                                                    class="product-img avatar-title img-thumbnail bg-success-subtle  border-0">
                                                    <img src="assets/images/product/img-4.png" class="img-fluid"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="avatar-md">
                                                <div
                                                    class="product-img avatar-title img-thumbnail bg-danger-subtle  border-0">
                                                    <img src="assets/images/product/img-5.png" class="img-fluid"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="col-xxl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="saleing-categories" data-colors='["#bf2126", "#4976cf","#6a92e1", "#e6ecf9"]'
                                ...
                                <table class="table table-centered align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="assets/images/flags/us.jpg" class="rounded"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="assets/images/flags/italy.jpg" class="rounded"
                                                        alt="user-image" height="18">
                                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="assets/images/flags/spain.jpg" class="rounded"
                                                        alt="user-image" height="18">
                                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="assets/images/flags/french.jpg" class="rounded"
                                                        alt="user-image" height="18">
                                                    <div class="flex-grow-1 ms-3">
