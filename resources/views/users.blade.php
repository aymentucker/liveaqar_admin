...
<head>
    ...
    <meta charset="utf-8" />
    <title>User List | webadmin - Admin & Dashboard Template</title>
...
<body>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <h5 class="card-title">Contact List <span
                                        class="text-muted fw-normal ms-2">(834)</span></h5>
                            </div>
                        </div>
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                                <div>
                                    <ul class="nav nav-pills">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="contacts-list.html"
                                                data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                data-bs-original-title="List" aria-label="List"><i
                                                    class="bx bx-list-ul"></i></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="contacts-grid.html" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title=""
                                                data-bs-original-title="Grid" aria-label="Grid"><i
                                        ...
                                        <table class="table table-nowrap align-middle">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span
                                                            class="badge bg-primary-subtle text-primary  mb-0">Backend
                                                            Developer</span></td>
            ...
            <div class="modal fade add-new" tabindex="-1" role="dialog"
